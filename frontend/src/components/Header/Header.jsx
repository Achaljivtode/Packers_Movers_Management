  ...
  return (
    <div>
      <header className="bg-slate-800 border">
        <nav
          className="flex max-w-[1550px] mx-auto items-center justify-between p-6 lg:px-8"
          aria-label="Global"
        >
          {/* logo */}
            ...
            {userRole === "" && (
              <>
                ...
                <div className="relative ">
                  ...
                  {/* login dropdown */}
                  {isDropDownVisible && (
                    <div className="absolute top-full -left-8 z-10 mt-3 lg:w-[300px] max-w-md overflow-hidden rounded-3xl bg-white ring-1 shadow-lg ring-gray-900/5">
                      <div className="p-4  ">
                        <h1
                          onClick={() => navigate("/user-login")}
                          className="hover:bg-gray-200 hover:cursor-pointer rounded-md px-3 py-3"
                        >
                          User
                        </h1>
                        <h1
