        ...
        <div className=' xl:w-[1300px] lg:w-[1000px] md:w-full mx-auto lg:mb-42'>
            <div className=' flex lg:flex-row  md:w-full sm:w-full lg:w-3/4 mx-auto lg:mt-20 md:mt-10 mt-5 px-10' >
                ...
                <div className=' w-full mx-auto lg:w-3/4'>
                    <input type="text" onKeyUp={(e)=> setSearch(e.target.value)} className='border lg:w-4/5 md:w-4/5  w-3/4  px-5 py-2' placeholder='Search Agent' />
                    <button onClick={handleSubmit} className=' lg:w-1/5 md:1/5 px-2 py-1 lg:px-5 lg:py-2 rounded-md hover:cursor-pointer hover:bg-orange-500 bg-orange-400 text-white font-bold '>Search</button>
                </div>
            </div>
