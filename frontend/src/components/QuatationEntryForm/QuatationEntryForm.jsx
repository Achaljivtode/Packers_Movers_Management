    ...
    <div>
        ...
        >
            ...
            <div className='flex flex-row mt-5'>
                ...
                <select name="service" id="service" className='border-1 border-gray-400 rounded-sm w-3/5 p-2'>
            ...
            <div className='flex flex-row mt-5'>
                ...
                <input id='from-address' name='from-address' type="text" className='border-1 border-gray-400 rounded-sm w-3/5 p-2' placeholder='Shift From Address' />
            </div>
            <div className='flex flex-row mt-5'>
                <label htmlFor="to-address" className=' w-2/5 flex lg:justify-end md:justify-end sm:justify-start pr-3'>Shift To Address: </label>
                <input id='to-address' name='to-address' type="text" className='border-1 border-gray-400 rounded-sm w-3/5 p-2' placeholder='Shift To Address' />
            </div>
            <div className='flex flex-row mt-5'>
                <label htmlFor="service-date" className=' w-2/5 flex lg:justify-end md:justify-end sm:justify-start pr-3'>Service Date</label>
                <input id='service-date' name='service-date' type="date" className='border-1 border-gray-400 rounded-sm w-3/5 p-2' />
            </div>
            <div className='flex flex-row mt-5'>
                <label htmlFor="reference" className=' w-2/5 flex lg:justify-end md:justify-end sm:justify-start pr-3'>References: </label>
                <input id='reference' name='reference' type="text" className='border-1 border-gray-400 rounded-sm w-3/5 p-2' placeholder='Enter References' />
            </div>
            <div className='flex flex-row mt-5'>
                ...
                <input id='service-details' name='service-details' type="text" className='border-1 border-gray-400 rounded-sm w-3/5 p-2' placeholder='Enter details of all items' />
            </div>
            <div className='mt-5 text-end'>
                <input type="submit" value="SUBMIT" className='w-full bg-orange-400 p-2 rounded-md text-white text-xl font-semibold'  />
            </div>
        </form>
    </div>
  )
