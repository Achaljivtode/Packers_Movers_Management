    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('register_as', models.CharField(choices=[('admin', 'admin'), ('agent', 'agent'), ('customer', 'customer')], default='customer', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('details_of_service', models.CharField(blank=True, max_length=255, null=True)),
                ...
                ('select_service', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='testapp.service')),
            ],
        ),
    ]
